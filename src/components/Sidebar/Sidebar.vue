  ...
  <div class="h-screen bg-primary text-white py-5 overflow-y-scroll font-mono text-sm"
    ...
    <div>
      ...
      <ul class="menu mt-5">
        ...
        <li class="flex items-center hover:bg-tertiary" :class="$route.name == `Favorite`?`bg-tertiary`:``"
            @click="goTo('Favorite')">
        ...
        <li class="flex items-center hover:bg-tertiary" :class="$route.name == `Comment`?`bg-tertiary`:``"
            @click="goTo('Comment')">
          <CommentIcon fill="#FFF"></CommentIcon>
          <p class="ml-4">បញ្ចេញមតិ</p>
        </li>
        <li class="flex items-center hover:bg-tertiary" :class="$route.name == `About`?`bg-tertiary`:``"
            @click="goTo('About')">
          <AboutIcon fill="#FFF"></AboutIcon>
          <p class="ml-4">អំពីយើង</p>
        </li>
        <li class="flex items-center hover:bg-tertiary" @click="()=>{this.isShare = true}">
          <ShareIcon fill="#FFF"></ShareIcon>
          <p class="ml-4">ចែករំលែក</p>
        </li>
        <li class="flex items-center hover:bg-tertiary" :class="$route.name == `Usage`?`bg-tertiary`:``"
            @click="goTo('Usage')">
          <QuestionIcon fill="#FFF"></QuestionIcon>
          <p class="ml-4">របៀបប្រើប្រាស់</p>
        </li>
        <li class="flex items-center hover:bg-tertiary" :class="$route.name == `Support`?`bg-tertiary`:``"
            @click="goTo('Support')">
