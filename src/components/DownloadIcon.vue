<template>
    <svg aria-hidden="true" focusable="false" data-prefix="far" :width="size" :height="size"  data-icon="arrow-to-bottom" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="svg-inline--fa fa-arrow-to-bottom fa-w-12 fa-3x">
