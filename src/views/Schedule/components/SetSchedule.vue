      ...
      <div style="max-height: 45rem;" class="overflow-y-scroll custom-scroll">
        ...
        <div class="p-5">
          ...
          <div class="mt-3">
            ...
            <div class="h-40 overflow-y-scroll custom-scroll mt-3">
...
export default {
  ...
  methods: {
    ...
    ...mapActions('schedule', ['createSchedule', 'getSchedule']),
    repeat (r) {
      if (r == 0) {
    ...
    save () {
      ...
      this.loading = true
      this.createSchedule(this.payload).then(() => {
        this.loading = false
        this.$emit('closeAdd')
        this.getSchedule()
      })
  ...
  mounted () {
    this.getSubject({}).then(() => {
      if (this.subjects.length) {
        this.subjectSelected = this.subjects[0]['subjectId']
      }
    })
    this.setAmPm()
  }
